...
log_paths = [
    ("./xception41_0.01.log", "0.01"),
    ("./xception41_0.001.log", "0.001"),
    ("./xception41_0.0001.log", "0.0001"),
    ("./xception41_0.0002.log", "0.0002"),
    ("./xception41_0.0003.log", "0.0003"),
    ("./xception41_0.0004.log", "0.0004"),
    ("./xception41_0.0005.log", "0.0005"),
    ("./xception41_1e-05.log", "1e-05"),
    ("./prezenta/lr_rate/xception71_9e-05.log", "1e-05"),
]
