...
def generate_dataset(cfg):
    ...
    train_transform, val_transform, test_transform  = data_transforms(cfg)
...
def generate_dataset_from_folder(data_path, train_transform, val_transform, test_transform):
    train_path = os.path.join(data_path, 'train')
    ...
    val_dataset = CustomizedImageFolder(val_path, val_transform, loader=img_loader)
