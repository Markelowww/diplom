...
parser.add_argument('--dataset_folder', type=str, default='./AMD_CSR_DME_DR_ERM_MH_NOmixxx', help='path to OCTDL folder')
parser.add_argument('--output_folder', type=str, default='./AMD_CSR_DME_DR_ERM_MH_NOmixxx2', help='path to output folder')
...
labels = ['AMD', 'CSR', 'DME', 'DR', 'ERM', 'MH', 'NO']
